...
export class ListTokensForSaleOperation2 extends BaseOperation2 {
    ...
    private readonly provider: Provider2;
    ...
    private ensureLiquidityNotTooLowInSatoshis(): void {
        ...
        if (u256.lt(liquidityInSatoshis, u256.fromU32(10_000))) {
            throw new Revert(
    ...
    private removeTax(provider: Provider2, totalTax: u128): void {
    ...
    private setProviderReceiver(provider: Provider2): void {
