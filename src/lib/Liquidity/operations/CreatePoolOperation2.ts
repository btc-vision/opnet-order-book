...
import { ListTokensForSaleOperation2 } from './ListTokensForSaleOperation2';

export class CreatePoolOperation2 extends BaseOperation2 {
    ...
    public execute(): void {
        ...
        const listTokenForSaleOp = new ListTokensForSaleOperation2(
            this.liquidityQueue,
            this.providerId,
